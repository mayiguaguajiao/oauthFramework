...
/*****************************
 ...
 oauthFramework - Sina Weibo Class
...
class WeiboOauth extends OauthBase {
	...
	{
		parent::__construct("sina", $url, $specialSet);
		
		$this->appkey = WEIBO_APP_KEY;
		$this->secretkey = WEIBO_SECRET_KEY;
	...
	public function callback()
	{
		...
		$this->writeData("name", $msg['screen_name']);
