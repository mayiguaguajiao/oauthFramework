...
/*****************************
 ...
 oauthFramework - Kaixin001 Class
...
class KaixinOauth extends OauthBase {
	...
	const CALLBACK = "kaixin001.php";
	const SCOPE = "basic";
	const GET_AUTH_CODE_URL = "http://api.kaixin001.com/oauth2/authorize";
    const GET_ACCESS_TOKEN_URL = "https://api.kaixin001.com/oauth2/access_token";
	const GET_USER_INFO_URL = "https://api.kaixin001.com/users/me.json";

	public function __construct($url = "", $specialSet = "")
	{
		parent::__construct("kaixin", $url, $specialSet);
		
		$this->appkey = KAIXIN_APP_KEY;
		$this->secretkey = KAIXIN_SECRET_KEY;
	...
	public function callback()
	{
		...
		$this->writeData("avatar", $msg['logo50']);
