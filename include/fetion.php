...
/*****************************
 ...
 oauthFramework - CMCC Fetion Class
...
class FetionOauth extends OauthBase {
	...
	const CALLBACK = "fetion.php";
	const SCOPE = "basic";
	const GET_AUTH_CODE_URL = "https://i2.feixin.10086.cn/oauththird/authorize";
    const GET_ACCESS_TOKEN_URL = "https://i.feixin.10086.cn/oauth2/access_token";
	const GET_USER_INFO_URL = "https://i.feixin.10086.cn/api/user.json";

	public function __construct($url = "", $specialSet = "")
	{
		parent::__construct("fetion", $url, $specialSet);
		
		$this->appkey = FETION_APP_KEY;
		$this->secretkey = FETION_SECRET_KEY;
	...
	public function callback()
	{
		...
		$this->writeData("uid", $msg['userId']);
		$this->writeData("name", $msg['nickname']);
		$this->writeData("avatar", $msg['portraitTiny']);
